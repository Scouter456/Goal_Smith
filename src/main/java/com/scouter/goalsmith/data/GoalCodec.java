...
public interface GoalCodec {
    Codec<GoalCodec> DIRECT_CODEC = ExtraCodecs.lazyInitializedCodec(() -> GSRegistries.GOAL_TYPE_SERIALIZER_SUPPLIER.get().getCodec()).dispatch(GoalCodec::codec, Function.identity());
