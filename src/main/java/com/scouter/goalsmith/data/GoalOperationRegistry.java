...
public class GoalOperationRegistry {
    public static final DeferredRegister<MapCodec<? extends GoalOperation>> GOAL_OPERATION = DeferredRegister.create(GSRegistries.Keys.GOAL_OPERATION_SERIALIZERS, MODID);
    public static final DeferredRegister<MapCodec<? extends TargetGoalOperation>> TARGET_GOAL_OPERATION = DeferredRegister.create(GSRegistries.Keys.TARGET_GOAL_OPERATION_SERIALIZERS, MODID);
