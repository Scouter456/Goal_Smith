...
public class NearestAttackableTargetGoalCodec implements TargetGoalCodec {
    ...
    ).apply(instance, (integer, entityTypeTagKey, integer2, aBoolean, aBoolean2, predicateCodec) -> new NearestAttackableTargetGoalCodec(integer, entityTypeTagKey, integer2, aBoolean, aBoolean2, (PredicateCodec<Entity>) predicateCodec)));
    ...
    public NearestAttackableTargetGoalCodec(int goalPriority, TagKey<EntityType<?>> targetType, int randomInterval, boolean mustSee, boolean mustReach, @Nullable PredicateCodec<Entity> targetPredicate) {
    ...
    public Goal addTargetGoal(PathfinderMob mob) {
        ...
        NearestAttackableTargetGoalImproved goal = new NearestAttackableTargetGoalImproved(mob, targetType, randomInterval, mustSee, mustReach, targetLivingEntityPredicate);
