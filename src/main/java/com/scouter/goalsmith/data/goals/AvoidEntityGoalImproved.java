...
public class AvoidEntityGoalImproved extends Goal {
     ...
     */
    protected final TagKey<EntityType<?>> avoidClass;
    protected final Predicate<LivingEntity> avoidPredicate;
    protected final Predicate<LivingEntity> predicateOnAvoidEntity;
    private final TargetingConditions avoidEntityTargeting;

    public AvoidEntityGoalImproved(PathfinderMob pMob, TagKey<EntityType<?>> pEntityClassToAvoid, float pMaxDistance, double pWalkSpeedModifier, double pSprintSpeedModifier) {
     ...
     */
    public AvoidEntityGoalImproved(
            PathfinderMob pMob,
            TagKey<EntityType<?>> pEntityClassToAvoid,
    ...
    public AvoidEntityGoalImproved(PathfinderMob pMob, TagKey<EntityType<?>> pEntityClassToAvoid, float pMaxDistance, double pWalkSpeedModifier, double pSprintSpeedModifier, Predicate<LivingEntity> pPredicateOnAvoidEntity) {
    ...
    public boolean canUse() {
        this.toAvoid = this.mob
                ...
                .getNearestEntity(
                        this.mob
                                .level()
                                .getEntitiesOfClass(LivingEntity.class, this.mob.getBoundingBox().inflate((double)this.maxDist, 3.0, (double)this.maxDist), entity -> entity.getType().is(avoidClass)),
